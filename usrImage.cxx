...
void Image::SetParametersFromITK( double origin3th, double spacing3th, TransformMatrix ITKimageMatrix, bool RAS )
{
  ...
  this->originImage[0] = origin[0];    this->originImage[1] = origin[1];      this->originImage[2] = origin3th;
  this->spacingImage[0] = spacing[0];  this->spacingImage[1] = spacing[1];    this->spacingImage[2] = spacing3th;

  this->imageMatrix = ITKimageMatrix;
  this->imageMatrix.SetDimensionsForIGTMatrix( this->sizeImage );
  this->imageMatrix.SetSpacingForIGTMatrix( this->spacingImage );

  // this is not automated, but the loaded images were LPS and the reslices and other images are RAS
  if ( RAS == false )// false is default
  {
